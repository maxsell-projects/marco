...
<head>
    ...
    <title>Novo Imóvel | José Carvalho Admin</title>
    ...
    <div class="flex h-full">
        ...
        <main class="flex-1 overflow-y-auto">
            <header class="bg-white border-b border-gray-200 sticky top-0 z-30 px-8 py-4 flex justify-between items-center shadow-sm">
                <div>
                    <h2 class="text-xl font-serif text-brand-primary">Adicionar Imóvel</h2>
                    <p class="text-xs text-gray-400 mt-0.5">Preencha os detalhes do novo ativo.</p>
                </div>
                ...
                <form action="{{ route('admin.properties.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="status" class="w-full border-gray-200 rounded px-4 py-3 bg-white focus:border-brand-cta focus:ring-0 text-sm cursor-pointer">
                                        <option value="Venda" {{ old('status') == 'Venda' ? 'selected' : '' }}>Para Venda</option>
                                        <option value="Arrendamento" {{ old('status') == 'Arrendamento' ? 'selected' : '' }}>Para Arrendamento</option>
                                    </select>
                                </div>
                                <div>
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="garages" value="{{ old('garages') }}" class="w-full border-gray-200 rounded px-4 py-3 focus:border-brand-cta focus:ring-0 text-sm" placeholder="Lugares">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 pt-6 border-t border-gray-50">
                            <div>
                                ...
                                <input type="text" name="floor" value="{{ old('floor') }}" class="w-full border-gray-200 rounded px-4 py-3 focus:border-brand-cta focus:ring-0 text-sm" placeholder="Ex: 3º Esq">
                            </div>
                            <div>
                                ...
                                <select name="orientation" class="w-full border-gray-200 rounded px-4 py-3 bg-white focus:border-brand-cta focus:ring-0 text-sm cursor-pointer">
                                    ...
                                    <option value="Nascente" {{ old('orientation') == 'Nascente' ? 'selected' : '' }}>Nascente (Este)</option>
                                    <option value="Poente" {{ old('orientation') == 'Poente' ? 'selected' : '' }}>Poente (Oeste)</option>
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div>
                                <label class="block text-[10px] uppercase tracking-widest text-gray-400 mb-2 font-bold">WhatsApp (Contacto Rápido)</label>
                                <div class="relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="p-6 border-2 border-dashed border-gray-200 rounded-lg hover:border-brand-premium transition-colors bg-gray-50/50">
                                ...
                                <p class="text-[10px] text-gray-400 mt-2 text-center">Pode selecionar múltiplos ficheiros.</p>
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
                        ...
                        <textarea name="description" rows="8" 
                                  ...
                                  placeholder="Descreva o imóvel com pormenores envolventes...">{{ old('description') }}</textarea>
                    </div>
