<header x-data="{ mobileMenuOpen: false, toolsOpen: false }" 
    ...
    <div class="container mx-auto px-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('home') }}" class="relative z-50 group block" @click="mobileMenuOpen = false">
                {{-- Removido 'invert' para o logo aparecer na cor original (assumindo que seja escuro/dourado) --}}
                {{-- Se o logo original for branco, avise para inverter via CSS novamente --}}
            ...
            <nav class="hidden lg:flex items-center gap-12">
                ...
                <div class="relative group" @mouseenter="toolsOpen = true" @mouseleave="toolsOpen = false">
                    ...
                    <div x-show="toolsOpen" 
                        ...
                        {{-- Dropdown agora Branco com borda Verde --}}
                ...
                {{-- Separador Fino (agora escuro/cinza) --}}
                <div class="h-4 w-px bg-brand-secondary/20"></div>

                {{-- CTA Outline (Verde sobre Branco) --}}
            ...
            {{-- 3. MOBILE MENU BUTTON (Cor ajustada para escuro) --}}
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden text-brand-secondary z-50 focus:outline-none p-2 group">
    ...
    {{-- 4. MOBILE MENU OVERLAY (Agora Branco Clean) --}}
    <div x-show="mobileMenuOpen" 
         ...
         class="fixed inset-0 bg-white z-40 flex flex-col justify-center overflow-hidden">
        
        <div class="absolute inset-0 flex justify-between px-10 opacity-5 pointer-events-none">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            <nav class="flex flex-col space-y-8">
                <a href="{{ route('home') }}" @click="mobileMenuOpen = false" class="text-4xl md:text-5xl font-serif text-brand-secondary hover:text-brand-primary transition-colors duration-500 group">
                ...
                <a href="{{ route('portfolio') }}" @click="mobileMenuOpen = false" class="text-4xl md:text-5xl font-serif text-brand-secondary hover:text-brand-primary transition-colors duration-500 group">
                ...
                <a href="{{ route('about') }}" @click="mobileMenuOpen = false" class="text-4xl md:text-5xl font-serif text-brand-secondary hover:text-brand-primary transition-colors duration-500 group">
                ...
                <div class="py-8 border-t border-brand-secondary/10 border-b border-brand-secondary/10 w-full max-w-xs mx-auto mt-8">
                ...
                <div class="mt-8">
                    <a href="{{ route('contact') }}" class="inline-block px-12 py-4 border border-brand-secondary text-brand-secondary uppercase text-xs font-bold tracking-widest hover:bg-brand-secondary hover:text-white transition-all">
                        {{ __('header.menu.schedule') }}
                    </a>
                </div>
            </nav>
