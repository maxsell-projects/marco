            ...
            <div class="flex flex-col items-center md:items-start">
                ...
                <div class="bg-white/5 p-4 rounded-lg w-full text-center md:text-left border border-white/5">
                    ...
                    <ul class="space-y-1 text-xs text-gray-300 font-mono">
                        ...
                        <li>NIF: <span class="text-white">500 000 000</span></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    <ul class="space-y-3 text-gray-400">
                        <li class="flex flex-col md:block">
                            ...
                            <span>Av. da Liberdade, 100, Lisboa</span>
                        </li>
                        <li class="flex flex-col md:block">
                        ...
                        <li class="flex flex-col md:block">
                            ...
                            <a href="mailto:contacto@josecarvalho.pt" class="hover:text-white transition">contacto@josecarvalho.pt</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center md:items-start justify-between">
                <div>
                    ...
                    <div class="flex gap-4 mb-8">
                        {{-- Instagram --}}
                        <a href="https://instagram.com" target="_blank" class="w-10 h-10 border border-white/20 flex items-center justify-center hover:bg-brand-premium hover:text-brand-primary hover:border-brand-premium transition-all duration-300 rounded-full group">
                        ...
                        {{-- Facebook --}}
                        <a href="https://facebook.com" target="_blank" class="w-10 h-10 border border-white/20 flex items-center justify-center hover:bg-brand-premium hover:text-brand-primary hover:border-brand-premium transition-all duration-300 rounded-full group">
                        ...
                        {{-- LinkedIn --}}
                        <a href="https://linkedin.com" target="_blank" class="w-10 h-10 border border-white/20 flex items-center justify-center hover:bg-brand-premium hover:text-brand-primary hover:border-brand-premium transition-all duration-300 rounded-full group">
                ...
                {{-- LIVRO DE RECLAMAÇÕES (LINK DE TEXTO) --}}
                <div class="mt-2">
